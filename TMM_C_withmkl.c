...
unsigned long long int multiplyMatrices(double *a, double *b, double *c, unsigned int triangular_matrix_size, unsigned int num_rows, unsigned int num_columns) {
...
int main() {
	...
	a = calloc(triangular_matrix_size*triangular_matrix_size, sizeof(double));
	b = calloc(triangular_matrix_size*triangular_matrix_size, sizeof(double));
	c = calloc(triangular_matrix_size*triangular_matrix_size, sizeof(double));
	...
	*/
	...
	printf("TMM using MKL dgemm: %.6f seconds\n", s_elapsed);
